<?php
session_start();
$mobd_id = $_GET['motherboard_id'];
//echo $gpu_id;
$connection = mysqli_connect('localhost','root','','ecommapp'); 
$ViewQuery = "SELECT * FROM motherboard inner join product ON motherboard.mobd_id = '$mobd_id' and product.mobo_id = '$mobd_id'";
...
<div id="content-wrapper">
		...
		<div class="column">
            ...
            <form action = '#' method = 'post'>
                            <input type = 'hidden' name = 'price' value = <?php echo $MSPEED; ?>>
...
<?php
 ...
 if(isset($_POST['submit'])){
  ...
  if($check_stock<0)
  {
      ...
      echo "<script>windows.location.href = 'motherboard_detail.php'</script>";
      return 0;
  }
  else
  {
   ...
   // print_r($_SESSION);
        ...
        //      echo "<script>windows.location = 'mobile_inf.php'</script>";
            ...
            {
            echo "<a href = 'motherboard_detail.php'></a>";
            }
        //      print_r($_SESSION);
            }
    //     //print_r($_SESSION);
