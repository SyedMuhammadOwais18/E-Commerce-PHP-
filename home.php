...
<nav class="navbar sticky-top navbar-expand-sm navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <li class="nav-item" >
        <a class="nav-link active " style="color: #052490; font-weight:bold"href="home.php">Home </a>
      </li>
...
<div style="background-color:#f5f5f5; height:100px">
<div class = 'container' style="padding-top: 1%;">
            <h1 style = 'text-align:center; color:#052490'>MOBILE</h1>
            <h6 style = 'text-align:center;'> The Most Prestigious Smartphone</h6>
</div>
</div>
  ...
  <?php 
    ...
    <div class = 'col-sm-3 offset-sm-1'>
            ...
            <div class = 'card'>
                ...
                <div class = 'btn-group d-flex align-items-center' style = 'padding-left:25%;'>
                        <!-- <button  class = 'btn btn-success flex-fill'>Add to cart</button></br> -->
                        <button class = 'btn btn-danger flex-fill' ><a href = 'mobile_detail.php?mobile_id=<?php echo $im['m1_id']; ?>' 
...
<div style="background-color:#f5f5f5; height:100px">
<div class = 'container' style="padding-top: 1%;">
            <h1 style = 'text-align:center; color:#052490'> LAPTOP</h1>
            <h6 style="text-align: center;"> A wide range of high-end laptops</h6>
    ...
    <div class = 'col-sm-3 offset-sm-1'>
        <div class = 'card'>
            <div class = 'card-body'>
                ...
                <div class = 'btn-group d-flex align-items-center' style = 'padding-left:25%;'>
                        <!-- <button  class = 'btn btn-success flex-fill'>Add to cart</button></br>  -->
                         <button class = 'btn btn-danger flex-fill' ><a href = 'laptop_detail.php?laptop_id=<?php echo $im['l1_id'];?>' style = 'color:white'>More Details
                         </a></button> 

                </div>
                <!-- <button class = 'btn btn-danger flex-fill' ><a href = 'laptop_detail.php?laptop_id=<?php echo $im['l1_id'];?>' style = 'color:white'>More Details</a></button> -->
...
<div style="background-color:#f5f5f5; height:100px">
<div class = 'container' style="padding-top: 1%;">
            <h1 style = 'text-align:center; color:#052490'> PC's</h1>
            <h6 style="text-align: center;">Build your dream PC</h6>
    </div>
        ...
        <div class = 'card'>
            <div class = 'card-body' style = 'margin-bottom: 1%;'>
                ...
                <div class = 'btn-group d-flex align-items-center' style = 'padding-left:25%;'>
                        ...
                        <!-- <button  class = 'btn btn-success flex-fill'>Add to cart</button></br> -->
                        <button class = 'btn btn-danger flex-fill' ><a href = 'motherboard_detail.php?motherboard_id=<?php echo $m_id; ?>' style = 'color:white'>More Details</a></button>
    ...
    <div class = 'col-sm-3 offset-sm-1'>
        <div class = 'card'>
            <div class= 'card-body'>
                ...
                <div class = 'btn-group d-flex align-items-center' style = 'padding-left:25%;'>
                        <!-- <button  class = 'btn btn-success flex-fill'>Add to cart</button></br> -->
                        <button class = 'btn btn-danger flex-fill' ><a href = 'processor_detail.php?processor_id=<?php echo $pr_id; ?>' style = 'color:white'>More Details</a></button>
    ...
    <div class = 'col-sm-3 offset-sm-1'>
        <div class = 'card'>
            <div class = 'card-body' >
                ...
                <div class = 'btn-group d-flex align-items-center' style = 'padding-left:25%;'>
                        <!-- <button  class = 'btn btn-success flex-fill'>Add to cart</button></br> -->
                        <button class = 'btn btn-danger flex-fill' ><a href = 'psu_detail.php?psu_id=<?php echo $p_id; ?>' style = 'color:white'>More Details</a></button>
        ...
        <div class = 'card'>
            <div class = 'card-body'>
                ...
                <div class = 'btn-group d-flex align-items-center'style = 'padding-left:25%;' >
                        ...
                        <button class = 'btn btn-danger flex-fill' ><a href = 'ram_detail.php?ram_id=<?php echo $r_id; ?>' style = 'color:white'>More Details</a></button>
        ...
        <div class = 'card'>
            <div class= 'card-body'>
                ...
                <div class = 'btn-group d-flex align-items-center' style = 'padding-left:25%;'>
                        ...
                        <a href = 'storagedevice_detail.php?sd_id=<?php echo $s_id; ?>' 
                        style = 'color:white'>More Details</a></button>
        ...
        <div class = 'card'>
            <div class = 'card-body'>
                ...
                <div class = 'btn-group d-flex align-items-center'style = 'padding-left:25%;' >
                        <!-- <button  class = 'btn btn-success flex-fill'>Add to cart</button></br> -->
                        <button class = 'btn btn-danger flex-fill ' >
                        <a href = 'gpu_detail.php?gpu_id=<?php echo $g_id; ?>' style = 'color:white'>More Details</a></button>
