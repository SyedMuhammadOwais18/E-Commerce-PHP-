 ...
 $ViewQuery = "SELECT * FROM motherboard inner join product on motherboard.mobd_id = product.mobo_id";
  ...
  while($DataRow = mysqli_fetch_assoc($Execute)){
   // $m_id = $DataRow['mobile_id'];
     ...
     $Images[] =  array('m_id' => $DataRow['mobd_id'],'m_name'=> $DataRow['mobd_name'],'m_img1'=> $DataRow['img1'],'m_stock'=> $DataRow['stock_quantity'] ,'m_price'=> $DataRow['mobd_price']);
    ...
    <li class="nav-item" >
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item active" style="color: white; font-weight:bold"  href="mobo_cat.php">Motherboard</a>
...
<div class = 'container'>
    <div class = 'row'>
        <div class = 'col-sm offset-sm-4'>
            <h1 style = 'margin-bottom:40px; margin-top:20px;'>Motherboard</h1>
...
<div class = 'row'>
  ...
  <?php 
    ...
    <div class = 'col-sm-3 offset-sm-1'>
            ...
            <div class = 'card'>
                <div class = 'card-body'>
                    <img src = '<?php echo $im['m_img1']; ?> ' alt = 'img1' class = 'img-responsive' height = '150' style = 'width : 150px;  margin-left:auto; margin-right:auto; display:block;'>
        
                    <div style = 'text-align:center;'>
                        <a href = '#'> <?php echo $im['m_name']; ?></a>
                    </div><!-- for name-->
                    <div style = 'text-align:center;'>
                     Price : <?php echo $im['m_price']; ?>
                    </div>
                    <div style = 'text-align:center;'>
                     availability : <?php if($im['m_stock']>0){
                         echo "in stock";
                     }else{
                         echo "out stock";
                        } ?>
                ...
                <form action = 'mobo_cat.php' method = 'post'>
                            <input type = 'hidden' name = 'price' value = <?php echo $im['m_price'] ; ?>>
                            <input type = 'hidden' name = 'stock' value = <?php echo $im['m_stock'] ; ?>>
                            <input type = 'hidden' name = 'm_id' value = <?php echo $im['m_id'] ; ?>>
                        ...
                        <button class = 'btn btn-danger flex-fill' ><a href = 'motherboard_detail.php?motherboard_id=<?php echo $im['m_id']; ?>' style = 'color:white'>More Details</a></button>
                        </form>
                        <!-- <button class = 'btn btn-danger flex-fill' ><a href = 'motherboard_detail.php?motherboard_id=<?php echo $im['m_id']; ?>' style = 'color:white'>More Details</a></button> -->
  ...
  else
  {
   ...
   // print_r($_SESSION);
        ...
        //      echo "<script>windows.location = 'mobile_inf.php'</script>";
            ...
            //  echo $count;
              if(check_stock()){
                $item_array = array('id' => $_POST['m_id'],'quantity' => $_POST['qty'],'stock' => $_POST['stock']);
             //print_r($item_array);
