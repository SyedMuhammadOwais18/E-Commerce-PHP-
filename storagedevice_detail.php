...
$ViewQuery = "SELECT * FROM storage_device inner join product ON storage_device.sd_id = '$sd_id' and product.sd_id = '$sd_id'";
...
while($DataRow = mysqli_fetch_array($Execute)){
  ...
  $ID = $DataRow['sd_id'];
  $Name = $DataRow['storage_name'];
  $MBN = $DataRow['sd_brand'];
	$MMN = $DataRow['sd_model_number'];
$MOS = $DataRow['sd_type'];
...
<div id="content-wrapper">
		...
		<div class="column">
			<img id=featured src="<?php echo $img1;   ?>">
		...
		<div class="column">
			<h1 class="product"><?php echo $Name;   ?></h1>
			<hr>
			<h3><?php  echo $SP;   ?></h3><br>
            ...
            <form action = '#' method = 'post'>
                            <input type = 'hidden' name = 'price' value = <?php echo $SP; ?>>
 ...
 if(isset($_POST['submit'])){
  ...
  function check_stock()
  {
    ...
    if($check_stock<0)
    {
        ...
        echo "<script>windows.location.href = 'storagedevice_detail.php'</script>";
        return 0;
    }
    else
    {
   ...
   // print_r($_SESSION);
        ...
        //      echo "<script>windows.location = 'mobile_inf.php'</script>";
            ...
            {
            echo "<a href = 'storagedevice_detail.php'></a>";
            }
        //      print_r($_SESSION);
            }
    //     //print_r($_SESSION);
