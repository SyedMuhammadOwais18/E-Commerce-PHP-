 ...
 $ViewQuery = "SELECT * FROM psu inner join product on psu.psu_id = product.psu_id";
  ...
  while($DataRow = mysqli_fetch_assoc($Execute)){
   // $m_id = $DataRow['mobile_id'];
     ...
     $Images[] =  array('p_id'=> $DataRow['psu_id'],'p_name'=> $DataRow['psu_name'],'p_img1'=> $DataRow['img1'],'p_stock'=> $DataRow['stock_quantity'] ,'p_price'=> $DataRow['psu_price']);
    ...
    <li class="nav-item" >
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item active" style="color: white; font-weight:bold" href="psu_cat.php">Power Supply</a>
...
<div class = 'container'>
    <div class = 'row'>
        <div class = 'col-sm offset-sm-4'>
            <h1 style = 'margin-bottom:40px; margin-top:20px;'> Power Supply</h1>
...
<div class = 'row'>
  ...
  <?php 
    ...
    <div class = 'col-sm-3 offset-sm-1'>
            ...
            <div class = 'card'>
                <div class = 'card-body'>
                    <img src = '<?php echo $im['p_img1']; ?> ' alt = 'img1' class = 'img-responsive' height = '150' style = 'width : 150px;  margin-left:auto; margin-right:auto; display:block;'>
        
                    <div style = 'text-align:center;'>
                        <a href = '#'> <?php echo $im['p_name']; ?></a>
                    </div><!-- for name-->
                    <div style = 'text-align:center;'>
                     Price : <?php echo $im['p_price']; ?>
                    </div>
                    <div style = 'text-align:center;'>
                     availability : <?php if($im['p_stock']>0){
                         echo "in stock";
                     }else{
                         echo "out stock";
                        } ?>
                ...
                <form action = 'psu_cat.php' method = 'post'>
                            <input type = 'hidden' name = 'price' value = <?php echo $im['p_price'] ; ?>>
                            <input type = 'hidden' name = 'stock' value = <?php echo $im['p_stock'] ; ?>>
                            <input type = 'hidden' name = 'p_id' value = <?php echo $im['p_id'] ; ?>>
                        ...
                        <button class = 'btn btn-danger flex-fill' ><a href = 'psu_detail.php?psu_id=<?php echo $im['p_id']; ?>' style = 'color:white'>More Details</a></button>
                        </form>
                        <!-- <button class = 'btn btn-danger flex-fill' ><a href = 'psu_detail.php?psu_id=<?php echo $im['p_id']; ?>' style = 'color:white'>More Details</a></button> -->
...
<?php
 ...
 if(isset($_POST['submit'])){
  ...
  if($check_stock<0)
  {
      ...
      echo "<script>windows.location.href = 'psu_cat.php'</script>";
      return 0;
  }
  else
  {
