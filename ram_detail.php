...
$ViewQuery = "SELECT * FROM ram inner join product ON ram.ram_id = '$ram_id'and product.ram_id = '$ram_id'";
...
<div id="content-wrapper">
		...
		<div class="column">
			...
			<hr>
			<h3><?php echo $MPRO;   ?></h3><br>
            <p><span class="dark-grey"><b>Brand:</b></span><span class="light-grey"> <?php  echo $MN;   ?> </span></p>
			<form action = '#' method = 'post'>
                            <input type = 'hidden' name = 'price' value = <?php echo $MPRO; ?>>
    ...
    <div style="padding-left: 100px;">
        ...
        <table width="600px" height="300px">
            <tr>
                ...
                <td class="specify"><?php echo $MMN;  ?></td>
            </tr>
            <tr>
  ...
  if(isset($_SESSION['user_username']) && isset($_SESSION['user_password'])){  
    ...
    function check_stock()
    {
      ...
      if($check_stock<0)
      {
          ...
          echo "<script>windows.location.href = 'ram_detail.php'</script>";
          return 0;
      }
      else
      {
