 ...
 $ViewQuery = "SELECT * FROM laptop inner join product on laptop.laptop_id = product.laptop_id";
  ...
  while($DataRow = mysqli_fetch_assoc($Execute)){
   // $m_id = $DataRow['mobile_id'];
     ...
     $Images[] =  array('l_id' => $DataRow['laptop_id'],'l_name'=> $DataRow['laptop_name'],'l_img1'=> $DataRow['img1'],'l_stock'=> $DataRow['stock_quantity']
     ,'l_price'=> $DataRow['laptop_price']);
    ...
    <li class="nav-item" >
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item active" style="color: white; font-weight:bold" href="laptop_cat.php">Laptops</a>
...
<div class = 'row'>
  ...
  <?php 
    ...
    <div class = 'col-sm-3 offset-sm-1'>
            ...
            <div class = 'card'>
                <div class = 'card-body'>
                    <img src = '<?php echo $im['l_img1']; ?> ' alt = 'img1' class = 'img-responsive' height = '150' style = 'width : 150px;  margin-left:auto; margin-right:auto; display:block;'>
        
                    <div style = 'text-align:center;'>
                        <a href = '#'> <?php echo $im['l_name']; ?></a>
                    </div><!-- for name-->
                    <div style = 'text-align:center;'>
                     Price : <?php echo $im['l_price']; ?>
                    </div>
                    <div style = 'text-align:center;'>
                     availability : <?php if($im['l_stock']>0){
                         echo "in stock";
                     }else{
                         echo "out stock";
                        } ?>
                ...
                <form action = 'laptop_cat.php' method = 'post'>
                            <input type = 'hidden' name = 'price' value = <?php echo $im['l_price'] ; ?>>
                            <input type = 'hidden' name = 'stock' value = <?php echo $im['l_stock'] ; ?>>
                            <input type = 'hidden' name = 'l_id' value = <?php echo $im['l_id'] ; ?>>
                        ...
                        <button class = 'btn btn-danger flex-fill' ><a href = 'laptop_detail.php?laptop_id=<?php echo $im['l_id'] ?>' style = 'color:white'>More Details</a></button>
                        </form>
                        <!-- <button class = 'btn btn-danger flex-fill' ><a href = 'laptop_detail.php?laptop_id=<?php echo $im['l_id'] ?>' style = 'color:white'>More Details</a></button> -->
...
<?php
 ...
 if(isset($_POST['submit'])){
  ...
  $id = $_POST['l_id'];
  $laptop_stock = $_POST['stock'];
  $quantity = $_POST['qty'];
  $check_stock = $laptop_stock - $quantity;
  if($check_stock<0)
  {
  
      echo "<script>alert('Not enough stock')</script>";
      echo "<script>windows.location.href = 'laptop_cat.php'</script>";
      return 0;
  }
  else
  {
   ...
   // print_r($_SESSION);
        ...
        //      echo "<script>windows.location = 'mobile_inf.php'</script>";
            ...
            //  echo $count;
            if(check_stock()){
             $item_array = array('id' => $_POST['l_id'],'quantity' => $_POST['qty'],'stock' => $_POST['stock']);
             //print_r($item_array);
