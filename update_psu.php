...
<h1>Update PSU</h1>
<div class="centre">
	<form action = 'update_psu.php?Update=<?php echo $Update_Id; ?>' method ='post' enctype = 'multipart/form-data'>
		<fieldset>
		...
		<div class="form-group"><label>watts:</label><br><input class="form-control" type = 'text' name = 'watts' value = '<?php echo $MOS; ?>'  ></input><br></div>
        <div class="form-group"><label>RGB Fans:</label><br><input class="form-control" type = 'text' name = 'RGBF' value = '<?php echo $MPRO; ?>'  ></input><br></div>
        <div class="form-group"><label>Form Factor:</label><br><input class="form-control" type = 'text' name = 'FormF' value = '<?php echo $MCORE; ?>'  ></input><br></div>
	    <div class="form-group"><label>Fan Size:</label><br><input class="form-control" type = 'text' name = 'FanS' value = '<?php echo $MSPEED; ?>'  ></input><br></div>
        <div class="form-group"><label>Price:</label><br><input class="form-control" type = 'text' name = 'PsuP' value = '<?php echo $MGPU; ?>' ></input><br></div>
...
if(isset($_POST['submit'])){
    ...
    fan_size = '$h',psu_price = '$i' WHERE psu_id = '$update_record'";
