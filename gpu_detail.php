...
$ViewQuery = "SELECT * FROM gpu inner join product ON gpu.gpu_id = '$gpu_id' and product.gpu_id = '$gpu_id'";
...
<div id="content-wrapper">
		...
		<div class="column">
			<h1 class="product"><?php echo $GN;   ?></h1>
			<hr>
			<h3><?php echo $GPR;   ?></h3><br>
            <p><span class="dark-grey"><b>Model No:</b></span> <span class="light-grey"><?php  echo $GMN;   ?></span> </p>
            <p><span class="dark-grey"><b>Brand:</b></span><span class="light-grey"> <?php  echo $GBN;   ?> </span></p>
      ...
      <!-- <b><span class="dark-grey">Quatity:     </b></span><input maxlength="1" style="border-color:#f5f5f5" type="number" min="1" max="2" value="1" name="qty" > -->
                            <input type = 'hidden' name = 'price' value = <?php echo $GPR; ?>>
    ...
    <div style="padding-left: 100px;">
        ...
        <table width="600px" height="300px">
            <tr>
                <th class="spec">Type</th>
                <td class="specify"><?php echo $GT;  ?></td>
            </tr>
            <tr>
                <td class="spec">Memory</td>
                <td class="specify"><?php echo $GMEM;  ?></td>
            </tr>
            <tr>
                <td class="spec">Boost Clock</td>
                <td class="specify"><?php echo $GBC;  ?></td>
            </tr>
            <tr>
                <td class="spec">Fans</td>
                <td class="specify"><?php echo $GF;  ?></td>
            </tr>
            <tr>
                <td class="spec">Ports</td>
                <td class="specify"><?php echo $GPO;  ?></td>
            </tr>
        </table>
    </div>
    </div>
...
<?php
 ...
 if(isset($_POST['submit'])){
  ...
  if($check_stock<0)
  {
      ...
      echo "<script>windows.location.href = 'gpu_detail.php'</script>";
      return 0;
  }
  else
  {
