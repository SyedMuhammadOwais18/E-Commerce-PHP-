...
<div class="centre">
	<form action = 'update_motherboard.php?Update=<?php echo $Update_Id; ?>' method ='post' enctype = 'multipart/form-data'>
		<fieldset>
        <div class="form-group">Name:<br><input class="form-control" type = 'text' name = 'MName' value = '<?php echo $MN; ?>'></input><br></div>
		<div class="form-group">Motherboard Brand Name:<br><input class="form-control" type = 'text' name = 'MBName' value = '<?php echo $MBN; ?>'></input><br></div>
		<div class="form-group">Motherboard Model Number:<br><input class="form-control" type = 'text' name = 'MMNUmber' value = '<?php echo $MMN; ?>'></input><br></div>
		<div class="form-group">Motherboard Chipset:<br><input class="form-control" type = 'text' name = 'Mchip' value = '<?php echo $MOS; ?>'></input><br></div>
		<div class="form-group">Motherboard Operating System:<br><input class="form-control" type = 'text' name = 'MOS' value = '<?php echo $MPRO; ?>' ></input><br></div>
		<div class="form-group">Motherboard Dimension:<br><input class="form-control" type = 'text' name = 'MD' value = '<?php echo $MCORE; ?>' ></input><br></div>
        <div class="form-group">Motherboard Price:<br><input class="form-control" type = 'text' name = 'MP' value = '<?php echo $MSPEED; ?>'></input><br></div>
...
if(isset($_POST['submit'])){
    ...
    mobd_price = '$h' WHERE mobd_id = '$update_record'";
