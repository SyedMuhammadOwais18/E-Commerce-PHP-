...
<div class="sidenav" >
  ...
  <a class="active" href="view_psu.php">PSU</a>
  <a href="showing_order.php">View order</a>
</div>
<div class="mains">
<h1>Psu Products</h1>
<button class="btn btn-primary" type="button" >
        <a href = 'addpsu.php' style  = 'color : white; '>Add Psu</a>
      </button>
<div>
<br>
<br>
...
<?php
$connection = mysqli_connect('localhost','root','','ecommapp'); 
$ViewQuery = "SELECT psu.psu_id,psu.psu_name,product.stock_quantity 
FROM psu inner join product ON psu.psu_id = product.psu_id";
...
<td><a href= 'Update_psu.php?Update=<?php echo $ID; ?>'>Update</a></td>
</tr>
<?php } ?>
	</table>
...
$Delete_Query1 = "DELETE FROM product WHERE psu_id = '$Delete_record'";
