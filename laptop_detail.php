...
$ViewQuery = "SELECT * FROM laptop inner join product ON laptop.laptop_id = '$laptop_id' and product.laptop_id = '$laptop_id'";
...
<div id="content-wrapper">
		...
		<div class="column">
			<h1 class="product"><?php echo $LN;   ?></h1>
			<hr>
			<h3><?php echo $LP;   ?></h3><br>
            <p><span class="dark-grey"><b>Brand:</b></span><span class="light-grey"> <?php  echo $LBN;   ?> </span></p>
            <p><span class="dark-grey"><b>Model No:</b></span><span class="light-grey"> <?php  echo $LMN;   ?> </span></p>
      ...
      <form action = '#' method = 'post'>
                            <input type = 'hidden' name = 'price' value = <?php echo $LP ; ?>>
    ...
    <div style="padding-left: 100px;">
        ...
        <table width="600px" height="300px">
            <tr>
                <td class="spec">processor</th>
                <td class="specify"><?php echo $LPRO;  ?></td>
            </tr>
            <tr>
                <td class="spec">RAM</td>
                <td class="specify"><?php echo $LRAM;  ?></td>
            </tr>
            <tr>
                <td class="spec">SSD</td>
                <td class="specify"><?php echo $LSSD;  ?></td>
            </tr>
            <tr>
                <td class="spec">HDD</td>
                <td class="specify"><?php echo $LHDD;  ?></td>
            </tr>
            <tr>
                <td class="spec">GPU</td>
                <td class="specify"><?php echo $LGPU;  ?></td>
            </tr>
            <tr>
                <td class="spec">Battery Backup</td>
                <td class="specify"><?php echo $LBB;  ?></td>
            </tr>
            <tr>
                <td class="spec">Screen Size</td>
                <td class="specify"><?php echo $LSS;  ?></td>
            </tr>
...
<?php
 ...
 if(isset($_POST['submit'])){
  ...
  if($check_stock<0)
  {
      ...
      echo "<script>windows.location.href = 'laptop_detail.php'</script>";
      return 0;
  }
  else
  {
   ...
   // print_r($_SESSION);
        ...
        //      echo "<script>windows.location = 'mobile_inf.php'</script>";
            ...
            {
            echo "<a href = 'laptop_detail.php'></a>";
            }
        //      print_r($_SESSION);
            }
    //     //print_r($_SESSION);
