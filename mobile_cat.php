 ...
 $ViewQuery = "SELECT * FROM mobile inner join product on mobile.mobie_id = product.mobile_id";
  ...
  while($DataRow = mysqli_fetch_assoc($Execute)){
   // $m_id = $DataRow['mobile_id'];
     ...
     $Images[] =  array('m1_id' => $DataRow['mobie_id'],'m1_name'=> $DataRow['mobile_name'],'m1_img1'=> $DataRow['img1'],
    'm1_stock'=> $DataRow['stock_quantity'] ,'m1_price'=> $DataRow['price']);
    ...
    <li class="nav-item" >
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item active" style="color: white; font-weight:bold" href="mobile_cat.php">Mobiles</a>
          ...
          <a class="dropdown-item" href="home.php">Storage Device</a>
        </div>
      </li>
      <?php
  ...
  <?php 
    ...
    <div class = 'col-sm-3 offset-sm-1'>
            ...
            <div class = 'card'>
                ...
                <form action = 'mobile_cat.php' method = 'post'>
                            <input type = 'hidden' name = 'price' value = <?php echo $im['m1_price'] ; ?>>
                            <input type = 'hidden' name = 'stock' value = <?php echo $im['m1_stock'] ; ?>>
                            <input type = 'hidden' name = 'pr_id' value = <?php echo $im['m1_id'] ; ?>>
                        ...
                        <button class = 'btn btn-danger flex-fill' ><a href = 'mobile_detail.php?mobile_id=<?php echo $im['m1_id']; ?>' style = 'color:white'>More Details</a></button>
                        </form>
                        <!-- <button class = 'btn btn-danger flex-fill' ><a href = 'mobile_detail.php?mobile_id=<?php echo $im['m1_id']; ?>' style = 'color:white'>More Details</a></button> -->
  ...
  if(isset($_SESSION['user_username']) && isset($_SESSION['user_password'])){
    function check_stock(){
      ...
      if($check_stock<0)
      {
          ...
          echo "<script>windows.location.href = 'mobile_cat.php'</script>";
          return 0;
      }
      else
      {
