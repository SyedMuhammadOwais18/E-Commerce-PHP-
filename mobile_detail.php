...
$ViewQuery = "SELECT * FROM mobile inner join product ON mobile.mobie_id = '$m_id' and product.mobile_id = '$m_id'";
...
<div id="content-wrapper">
      ...
      <!-- <b><span class="dark-grey">Quatity:     </b></span><input maxlength="1" style="border-color:#f5f5f5" type="number" min="1" max="2" value="1" name="qty" > -->
                            <input type = 'hidden' name = 'price' value = <?php echo $MP; ?>>
      ...
      <!-- <a class="btn btn-primary" style="background-color:#052490 ;" href="#"><i class="fas fa-shopping-cart"></i> Add to Cart</a> -->
		</div>
    ...
    <div style="padding-left: 100px;">
        ...
        <table width="600px" height="600px">
            ...
            <tr>
                <td class="spec">CPU Core</td>
                <td class="specify"><?php echo $MCORE;  ?></td>
            </tr>
            <tr>
                <td class="spec">CPU Speed</td>
            ...
            <tr>
                <td class="spec">Display Type</td>
                <td class="specify"><?php echo $MTYPE;  ?></td>
            </tr>
            <tr>
                <td class="spec">Display Size</td>
                <td class="specify"><?php echo $MSIZE;  ?></td>
            </tr>
            <tr>
                <td class="spec">Resolution</td>
                <td class="specify"><?php echo $MRES;  ?></td>
            </tr>
            <tr>
                <td class="spec">Memory</td>
                <td class="specify"><?php echo $MMEM;  ?></td>
            </tr>
            <tr>
                <td class="spec">Ram</td>
                <td class="specify"><?php echo $MRAM;  ?></td>
            </tr>
            <tr>
                <td class="spec">Front Camera</td>
                <td class="specify"><?php echo $MF;  ?></td>
            </tr>
            <tr>
                <td class="spec">Back Camera</td>
                <td class="specify"><?php echo $MB;  ?></td>
            </tr>
            <tr>
                <td class="spec">Back Camera Features</td>
                <td class="specify"><?php echo $MBF;  ?></td>
            </tr>
            <tr>
                <td class="spec">Battery Type</td>
                <td class="specify"><?php echo $MBT;  ?></td>
            </tr>
            <tr>
                <td class="spec">Colors</td>
                <td class="specify"><?php echo $MC;  ?></td>
            </tr>
...
<?php
 ...
 if(isset($_POST['submit'])){
  ...
  if($check_stock<0)
  {
      ...
      echo "<script>windows.location.href = 'mobile_detail.php'</script>";
      return 0;
  }
  else
  {
    ...
    //  // print_r($a);
        ...
        //      print_r($_SESSION);
              ...
              {
                echo "<a href = 'mobile_detail.php'></a>";
              }
            }
    //     //print_r($_SESSION);
