...
<div class="sidenav" >
  ...
  <a class="active" href="view_motherboard.php">Motherboard</a>
...
<button class="btn btn-primary" type="button" >
        <a href = 'addMobo.php' style  = 'color : white; '>Add Motherboard</a>
      </button>
<div>
<br>
<br>
...
<?php
$connection = mysqli_connect('localhost','root','','ecommapp'); 
$ViewQuery = "SELECT motherboard.mobd_id,motherboard.mobd_name,product.stock_quantity 
FROM motherboard inner join product ON motherboard.mobd_id = product.mobo_id";
...
<td><a href= 'Update_motherboard.php?Update=<?php echo $ID; ?>'>Update</a></td>
</tr>
<?php } ?>
	</table>
...
$Delete_Query1 = "DELETE FROM product WHERE mobo_id = '$Delete_record'";
