 ...
 $ViewQuery = "SELECT * FROM processor inner join product on processor.pre_id = product.pre_id";
  ...
  while($DataRow = mysqli_fetch_assoc($Execute)){
   // $m_id = $DataRow['mobile_id'];
     ...
     $Images[] =  array('pr_id' => $DataRow['pre_id'],'pr_name'=> $DataRow['pre_name'],'pr_img1'=> $DataRow['img1'] ,'pr_stock'=> $DataRow['stock_quantity'] ,'pr_price'=> $DataRow['pre_price']);
    ...
    <li class="nav-item" >
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item active" style="color: white; font-weight:bold" href="processor_cat.php">Processor</a>
...
<div class = 'container'>
    <div class = 'row'>
        <div class = 'col-sm offset-sm-4'>
            <h1 style = 'margin-bottom:40px; margin-top:20px;'> Processor</h1>
        </div>
...
<div class = 'row'>
  ...
  <?php 
    ...
    <div class = 'col-sm-3 offset-sm-1'>
            ...
            <div class = 'card'>
                <div class = 'card-body'>
                    <img src = '<?php echo $im['pr_img1']; ?> ' alt = 'img1' class = 'img-responsive' height = '150' style = 'width : 150px;  margin-left:auto; margin-right:auto; display:block;'>
        
                    <div style = 'text-align:center;'>
                        <a href = '#'> <?php echo $im['pr_name']; ?></a>
                    </div><!-- for name-->
                    <div style = 'text-align:center;'>
                     Price : <?php echo $im['pr_price']; ?>
                    </div>
                    <div style = 'text-align:center;'>
                     availability : <?php if($im['pr_stock']>0){
                         echo "in stock";
                     }else{
                         echo "out stock";
                        } ?>
                ...
                <form action = 'processor_cat.php' method = 'post'>
                        ...
                        <button class = 'btn btn-danger flex-fill' ><a href = 'processor_detail.php?processor_id=<?php echo $im['pr_id']; ?>' style = 'color:white'>More Details</a></button>
                        </form>
                        <!-- <button class = 'btn btn-danger flex-fill' ><a href = 'processor_detail.php?processor_id=<?php echo $im['pr_id']; ?>' style = 'color:white'>More Details</a></button> -->
...
<?php
 ...
 if(isset($_POST['submit'])){
  ...
  if($check_stock<0)
  {
      ...
      echo "<script>windows.location.href = 'processor_cat.php'</script>";
      return 0;
  }
  else
  {
   ...
   // print_r($_SESSION);
        ...
        //      echo "<script>windows.location = 'mobile_inf.php'</script>";
            ...
            {
              echo "<a href = 'processor_cat.php'></a>";
            }
        //      print_r($_SESSION);
            }
    //     //print_r($_SESSION);
